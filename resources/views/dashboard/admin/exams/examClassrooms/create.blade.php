        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <!-- Current Page: Tambah Kelas Baru -->
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2 font-medium">Tambah Kelas Baru</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden transition-all duration-200 hover:shadow-2xl">
                <div class="p-6 sm:p-8">
                    <form action="{{ route('exams.examClassrooms.store', $exam) }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="room" id="room" class="block w-full rounded-md">
                            </div>
                        </div>
