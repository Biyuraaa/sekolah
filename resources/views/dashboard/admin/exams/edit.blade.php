                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Edit Ujian</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Silahkan edit form berikut untuk mengubah data ujian.</p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('exams.update', $exam->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="date" name="date" id="date"
                                    ...
                                    value="{{ old('date', $exam->date) }}" required>
                                @error('date')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="time" name="end_time" id="end_time"
                                    ...
                                    value="{{ old('end_time', date('H:i', strtotime($exam->end_time))) }}" required>
                                @error('end_time')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="academic_year" id="academic_year"
                                ...
                                placeholder="Contoh: 2023/2024" value="{{ old('academic_year', $exam->academic_year) }}"
                                required>
                            @error('academic_year')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
