        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Tambah Fasilitas Baru</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Tambah Fasilitas Baru</h2>
                        <p class="text-sm text-gray-500">Silahkan lengkapi form berikut untuk menambahkan fasilitas baru.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('facilities.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Deskripsikan fasilitas ini">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="location" id="location"
                                ...
                                placeholder="Masukkan lokasi fasilitas" value="{{ old('location') }}" required>
                            @error('location')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="capacity" id="capacity"
                                    ...
                                    placeholder="Masukkan kapasitas fasilitas" value="{{ old('capacity') }}" required
                                    min="0">
                                @error('capacity')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
