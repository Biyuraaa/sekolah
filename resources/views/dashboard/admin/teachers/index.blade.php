                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Guru</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex justify-between items-center mb-8">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Kelola data seluruh guru dalam sistem</p>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Guru Aktif</dt>
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900">{{ $activeTeachers }}</div>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($teachers as $teacher)
                                <tr class="hover:bg-gray-50">
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    src="{{ $teacher->user->image ? asset('storage/images/users/' . $teacher->user->image) : 'https://ui-avatars.com/api/?name=' . urlencode($teacher->name) }}"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $teacher->position->name }}</div>
                                        ...
                                        <div class="flex space-x-2">
                                            <a href="{{ route('teachers.show', $teacher) }}"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7H2.458z" />
                                                </svg>
                                            </a>
                                            <a href="{{ route('teachers.edit', $teacher) }}"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M12 14V20M12 20a2 2 0 002 2M12 20a2 2 0 01-2 2M12 20v-6M12 20v-2">
                                                    </path>
                                                </svg>
                                            </a>
