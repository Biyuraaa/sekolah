        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Edit Jabatan</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Edit Jabatan</h2>
                        <p class="text-sm text-gray-500">Silahkan edit form berikut untuk mengubah data jabatan.</p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('positions.update', $position) }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Masukkan nama jabatan" value="{{ old('name', $position->name) }}" required>
                            @error('name')
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative mt-1 rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="base_salary" id="base_salary"
                                        class="block w-full rounded-md border-gray-300 pl-12 pr-12 focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('base_salary') border-red-300 @enderror"
                                        placeholder="0.00" value="{{ old('base_salary', $position->base_salary) }}" required
                                        step="0.01" min="0">
                                </div>
                                @error('base_salary')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative mt-1 rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="allowance" id="allowance"
                                        class="block w-full rounded-md border-gray-300 pl-12 pr-12 focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('allowance') border-red-300 @enderror"
                                        placeholder="0.00" value="{{ old('allowance', $position->allowance) }}" required
                                        step="0.01" min="0">
                                </div>
                                @error('allowance')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        ...
                        <div class="space-y-1">
                            ...
                            <textarea name="responsibilities" id="responsibilities" rows="4"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('responsibilities')
                                border-red-300 @enderror"
                                placeholder="Deskripsikan tanggung jawab untuk jabatan ini">{{ old('responsibilities', $position->responsibilities) }}</textarea>
