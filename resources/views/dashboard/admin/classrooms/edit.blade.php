        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Edit Kelas</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Edit Kelas</h2>
                        <p class="text-gray-600 mt-1">Edit informasi kelas untuk memperbarui data yang ada di sistem</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden transition-all duration-200 hover:shadow-2xl">
                <form action="{{ route('classrooms.update', $classroom->id) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                    <div class="space-y-8">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <select name="year_level" id="year_level"
                                            ...
                                            required>
                                            <option value="10" {{ $classroom->year_level == 10 ? 'selected' : '' }}>
                                                Kelas 10</option>
                                            <option value="11" {{ $classroom->year_level == 11 ? 'selected' : '' }}>
                                                Kelas 11</option>
                                            <option value="12" {{ $classroom->year_level == 12 ? 'selected' : '' }}>
                                                Kelas 12</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <select name="group_numbers" id="group_numbers"
                                            ...
                                            @for ($i = 1; $i <= 10; $i++)
                                                <option value="{{ $i }}"
                                                    {{ $classroom->group_numbers == $i ? 'selected' : '' }}>
                                                    {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="batch_name" id="batch_name"
                                            class="pl-10 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-green-500 focus:border-green-500 transition-colors duration-200"
                                            placeholder="Masukkan nama angkatan" value="{{ $classroom->batch_name }}">
                                    </div>
                                    @error('batch_name')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <select name="teacher_id" id="teacher_id"
                                    ...
                                    @foreach ($teachers as $teacher)
                                        <option value="{{ $teacher->id }}" class="text-black"
                    ...
                    <div class="flex justify-end mt-8">
                        <a href="{{ route('classrooms.index') }}"
                            class="bg-gray-100 hover:bg-gray-200 px-5 py-2 rounded-md font-medium text-gray-700 mr-4 transition-all duration-200">Batal</a>
                        <button type="submit"
                            class="bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded-md font-medium transition-all duration-200">
                            Perbarui
                        </button>
                    </div>
                </form>
