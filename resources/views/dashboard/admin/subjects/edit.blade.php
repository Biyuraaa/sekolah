        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Edit Mata Pelajaran</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Edit Mata Pelajaran</h2>
                        <p class="text-gray-600 mt-1">Perbarui informasi mata pelajaran yang sudah ada dalam sistem</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden transition-all duration-200 hover:shadow-2xl">
                <form action="{{ route('subjects.update', $subject->id) }}" method="POST" class="p-8">
                    @csrf
                    @method('PUT')
                    <div class="space-y-8">
                        <!-- Subject Information -->
