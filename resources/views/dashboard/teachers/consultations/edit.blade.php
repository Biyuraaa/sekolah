        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Edit Jadwal Konsultasi</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Edit Jadwal Konsultasi</h2>
                        <p class="text-sm text-gray-500">Silahkan perbarui jadwal konsultasi yang telah dibuat.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="text" name="location" id="location"
                                    ...
                                    placeholder="Masukkan lokasi konsultasi"
                                    value="{{ old('location', $consultation->location) }}" required>
                                @error('location')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-1">
                                ...
                                <input type="time" name="start_time" id="start_time"
                                    ...
                                    value="{{ old('start_time', $consultation->start_time) }}" required>
                                @error('start_time')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="time" name="end_time" id="end_time"
                                    ...
                                    value="{{ old('end_time', $consultation->end_time) }}" required>
                                @error('end_time')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="space-y-1">
                                ...
                                <input type="number" name="max_appointments" id="max_appointments"
                                    ...
                                    value="{{ old('max_appointments', $consultation->max_appointments) }}" required
                                    min="1">
                            ...
                            <div class="space-y-1">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="active"
                                        {{ old('status', $consultation->status) == 'active' ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="inactive"
                                        {{ old('status', $consultation->status) == 'inactive' ? 'selected' : '' }}>Non
                                        Active
                                    </option>
                                </select>
                                @error('status')
