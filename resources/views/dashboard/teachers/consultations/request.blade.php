                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Pengajuan Konsultasi</span>
                        </div>
                    </li>
                </ol>
            </nav>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($consultations as $consultation)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ $consultation->max_appointments }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span
                                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-{{ $consultation->status === 'available' ? 'green' : 'red' }}-100 text-{{ $consultation->status === 'available' ? 'green' : 'red' }}-800">
                                            {{ $consultation->status }}
                                        </span>
                                    </td>
