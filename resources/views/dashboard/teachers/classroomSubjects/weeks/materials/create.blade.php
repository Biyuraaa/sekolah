        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-extrabold text-gray-900">Buat Materi Mata Pelajaran</h2>
                        <p class="text-sm text-gray-500 mt-1">
                            Buat materi untuk mata pelajaran <span
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mx-auto my-8">
                <div class="p-6 sm:p-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Tambah Materi Baru</h2>
                    ...
                    <form id="materialForm" action="{{ route('weeks.materials.store', [$classroomSubject, $week]) }}"
