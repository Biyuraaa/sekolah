        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('classroomSubjects.create') }}"
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    src="{{ $classroomSubject['teacher']['user']['image'] ? asset('storage/images/users/' . $classroomSubject['teacher']['user']['image']) : 'https://ui-avatars.com/api/?name=' . urlencode($classroomSubject['teacher']['user']['name']) }}"
                                                    alt="{{ $classroomSubject['teacher']['user']['name'] }}">
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $classroomSubject['teacher']['user']['name'] }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
