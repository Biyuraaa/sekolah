...
@section('content')
    <div class="min-h-screen bg-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-300 ease-in-out transform hover:-translate-y-0.5 shadow-md hover:shadow-lg">
                                                    ...
                                                    <div class="p-6">
                                                        ...
                                                        @else
                                                            <div
                                                                ...
                                                                <div class="mt-6">
                                                                    <a href="{{ route('weeks.materials.create', [$classroomSubject, $week]) }}"
                                                                        class="inline-flex items-center px-6 py-2.5 border border-transparent text-base font-medium rounded-lg 
                        text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-300 ease-in-out transform hover:-translate-y-0.5 shadow-md hover:shadow-lg">
