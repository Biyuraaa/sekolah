        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Absensi</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex justify-between items-center mb-8">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Absensi Saya</h2>
                    ...
                    @if ($classroomSubjects->count() > 0)
                        ...
                        <div class="flex flex-col space-y-6">
                            @foreach ($classroomSubjects as $classroomSubject)
                                <a href="{{ route('attendances.show', $classroomSubject->id) }}" class="block group">
                                    <div
