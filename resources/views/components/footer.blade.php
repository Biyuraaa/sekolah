        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div class="space-y-4">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Empowering education through innovative technology and seamless management solutions.
                </p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('home') }}"
                            class="text-gray-600 hover:text-blue-600 transition-colors duration-300 flex items-center space-x-2">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="#"
                            class="text-gray-600 hover:text-blue-600 transition-colors duration-300 flex items-center space-x-2">
                            <span>→</span><span>Cookies Policy</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-gray-500 text-sm">
                    &copy; {{ date('Y') }} EduSync School Management System. All Rights Reserved.
                </p>
