                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-500 ml-1 md:ml-2">Profile</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex justify-between items-center mb-8">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Lihat dan kelola informasi akun Anda</p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('profile.edit') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="-ml-1 mr-2 h-5 w-5" fill="none"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 14V10m0 0V6m0 4h6m-6 0H6" />
                        </svg>
                        Edit Profil
                    </a>
                </div>
                        ...
                        <div class="ml-6 w-full">
                            ...
                            <div class="mt-4 flex items-center space-x-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-gray-500 text-sm">{{ auth()->user()->role }}</span>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-500 text-sm">{{ auth()->user()->date_of_birth }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-base text-gray-900">{{ auth()->user()->phone_number }}</p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="bg-blue-100 p-3 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-base text-gray-900">{{ auth()->user()->address }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
